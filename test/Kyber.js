...
const TestToken = artifacts.require("./SampleERC20.sol");
...
const tokenPerAccount = new BigNumber(10**40);
  ...
  return new Promise(function (fulfill, reject){
      ...
      return inputs.reduce(function (promise, item) {
       return promise.then(function () {
           ...
           return TestToken.new(BigNumber(10**68).toString(), name, decimals, symbol, {from:owner});
          ...
          return TestToken.new(BigNumber(10**68).toString(), kgtName, kgtDec, kgtSymbol).then(function (instance) {
...
*/
  ...
  it("Should deploy Burner and Trust Factory", async() => {
    ...
    burner = await MyBitBurner.new(tokenInstance[0].address, networkProxy.address);
    factory = await TrustFactory.new(burner.address);
    await burner.authorizeBurner(factory.address);
